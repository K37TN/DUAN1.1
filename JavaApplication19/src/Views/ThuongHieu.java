  ...
  DefaultTableModel model = new DefaultTableModel();
   DefaultTableModel defaultTableModel1;
    List<Hang> list;
     ...
     private ThuongHieuRepository repository1;
    public ThuongHieu() {
        initComponents();
           this.repository1 = new ThuongHieuRepository();
...
private void filltable() {
    model.setRowCount(0);
        List<Hang> list = repository.getHang();
        for (Hang x : list) {
